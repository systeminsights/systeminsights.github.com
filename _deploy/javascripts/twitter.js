...
function getTwitterFeed(user, count, replies) {
  ...
  $.ajax({
      url: "https://api.twitter.com/1.1/statuses/user_timeline.json?screen_name=" + user + "&trim_user=true&count=" + (count + 20) + "&include_entities=1&exclude_replies=" + (replies ? "0" : "1") + "&callback=?"
    , type: 'jsonp'
